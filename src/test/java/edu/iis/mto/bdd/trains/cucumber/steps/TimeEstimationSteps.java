...
public class TimeEstimationSteps {
    ...
    public void giveStartAndStopLine(String departure, String destination) throws Throwable {
    ...
    public void shouldBeInformedAboutArrivalTime(@Transform(JodaLocalTimeConverter.class) LocalTime arrivalTime) throws Throwable {
        throw new PendingException();
    }
}
